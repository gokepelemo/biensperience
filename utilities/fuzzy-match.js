 ...
 */
function findSimilarItems(array, value, fieldName = 'name', threshold = 85) {
 ...
 * @param {string} fieldName - Field name to compare (default: 'name')
 * @param {number} threshold - Similarity threshold (default: 85)
 * @returns {Object|null} - Returns the matching item if duplicate exists, null otherwise
 */
function findDuplicateFuzzy(array, value, fieldName = 'name', threshold = 85) {
