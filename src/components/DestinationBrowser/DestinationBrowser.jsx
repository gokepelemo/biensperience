...
export default function DestinationBrowser({
  ...
  return (
    <div className={styles.destinationBrowser}>
      {/* Header */}
      <div className={styles.destinationBrowserHeader}>
        <div>
          <h1 className={styles.destinationBrowserTitle}>{title}</h1>
          <p className={styles.destinationBrowserSubtitle}>{subtitle}</p>
        </div>
        <div className={styles.destinationBrowserActions}>
          <button className={styles.btnIcon} aria-label="Share">
          ...
          <button className={styles.btnIcon} aria-label="Bookmark">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      ...
      <div className={styles.destinationBrowserSearch}>
        <Autocomplete
      ...
      <div className={styles.destinationBrowserFilters}>
      ...
      <div className={styles.destinationBrowserViewToggle}>
        ...
        <div className={styles.viewToggleButtons}>
          ...
          <button className={styles.btnIcon} aria-label="Grid view">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      ...
      {/* Destination Cards */}
      <div className={styles.destinationBrowserContent}>
...
function DestinationCard({ destination, onClick }) {
  ...
  return (
    <article className={styles.destinationCard} onClick={onClick}>
      <div className={styles.destinationCardImage}>
        ...
        {badge && <span className={styles.destinationBadge}>{badge}</span>}
        <button className={styles.destinationFavorite} aria-label="Add to favorites">
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      ...
      <div className={styles.destinationCardContent}>
        <div className={styles.destinationCardHeader}>
          <span className={styles.destinationCategory}>{badge}</span>
        ...
        <div className={styles.destinationAmenities}>
