...
const VARIANT_CONFIG = {
  ...
  documents: {
    ...
    description: 'Upload travel documents like reservations, tickets, or receipts to keep everything organized.',
  ...
  mapLocations: {
    ...
    description: 'Try adjusting your search or filters to find destinations and experiences on the map.',
    primaryAction: 'Clear Filters',
    secondaryAction: null,
  },
  generic: {
