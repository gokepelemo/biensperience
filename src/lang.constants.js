...
const en = {
  ...
  label: {
    ...
    travelingFromPlaceholder: "City, region, or country you're traveling from",
    travelingFromTooltip: "Where are you traveling from? This helps estimate your travel cost to reach the destination.",
    travelOrigins: "Travel Origins",
    travelOriginsTooltip: "Where each member is traveling from. This helps with travel cost estimation.",
    myTravelOrigin: "My Travel Origin",
    setTravelingFrom: "Set Origin",
    updateTravelingFrom: "Update Origin",
    travelCostEstimate: "Estimated Travel Cost",
    travelCostEstimatePlaceholder: "0.00",
    travelCostEstimateTooltip: "Optional: your estimated travel cost to reach the destination (flights, transport, etc.)",
    travelingFromNotSet: "Not set",
    removeOrigin: "Remove",
    ...
    estimatedCostsTooltipHeader: "Estimated vs. Tracked Costs",
    estimatedCostsExplanation: "Estimated costs are forecasted budgets from experience creators. Tracked costs are real expenses you've recorded.",
    trackedCostsMyPlans: "My Plans",
    trackedCostsSharedPlans: "Shared Plans",
    trackedCostsTotal: "Total Tracked",
    messages: "Messages",
    ...
    experienceVisibilityPublic: "Public",
    experienceVisibilityContributors: "Contributors Only",
    experienceVisibilityPrivate: "Private (Only Me & Collaborators)",
  ...
  cost: {
    ...
    assignedTo: "Paid by",
    paidFor: "Paid for",
    assignedToPlaceholder: "Select who paid",
    assignedToPlanItem: "For Plan Item",
    assignedToPlanItemPlaceholder: "Select plan item",
  ...
  profile: {
    ...
    linkedAccountsDescription: "Connect social accounts to sign in faster and access additional features.",
    linkedFacebook: "Facebook",
    linkedGoogle: "Google",
    linkedTwitter: "X (Twitter)",
    linked: "Linked",
    notLinked: "Not linked",
    linkAccount: "Link",
    unlinkAccount: "Unlink",
    linkingAccount: "Linking...",
    unlinkingAccount: "Unlinking...",
    accountLinkedAt: "Linked on {date}",
    cannotUnlinkOnlyAuth: "Cannot unlink your only authentication method. Please set a password or link another account first.",
    noLinkedAccounts: "No accounts linked. Link a social account to sign in faster.",
    confirmUnlink: "Unlink {provider} Account",
    confirmUnlinkMessage: "Are you sure you want to unlink your {provider} account? You will no longer be able to sign in with {provider}.",
    accountLinkedSuccess: "{provider} account linked successfully",
    accountUnlinkedSuccess: "{provider} account unlinked successfully",
    failedToLinkAccount: "Failed to link {provider} account. Please try again.",
    failedToUnlinkAccount: "Failed to unlink {provider} account. Please try again.",
    failedToLoadLinkedAccounts: "Failed to load linked accounts",
