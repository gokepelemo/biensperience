...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Photo card component for displaying images with optional titles, captions, and user information. Supports various layouts and is used for photo galleries and experience documentation.',
      },
    },
  },
  tags: [],
