...
// ============================================
// Form Restoration Time Formatting
// (Consolidated from time-format.js)
// ============================================

/**
 * Format age in milliseconds to friendly relative time string
 * Used for form restoration messages
 *
 * @param {number} ageMs - Age in milliseconds
 * @returns {string} Friendly time string (e.g., "5 minutes ago")
 */
 ...
 * Used for form restoration toast messages
 *
 * @param {number} ageMs - Age in milliseconds
 * @param {string} context - 'create' or 'update'
 * @returns {string} Friendly message for form restoration
 */
